...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, setCookie, getResponseStatusText } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/devalue/index.js';
import destr from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/vue/index.mjs';
import { basename, isAbsolute } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///mnt/2E3051B82E95158A/Projects/sirius-dev/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/mnt/2E3051B82E95158A/Projects/sirius-dev/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/mnt/2E3051B82E95158A/Projects/sirius-dev/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/2E3051B82E95158A/Projects/sirius-dev","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/2E3051B82E95158A/Projects/sirius-dev/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/2E3051B82E95158A/Projects/sirius-dev/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/2E3051B82E95158A/Projects/sirius-dev/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/mnt/2E3051B82E95158A/Projects/sirius-dev/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _zJsFxZJu2j = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/mnt/2E3051B82E95158A/Projects/sirius-dev";
...
const _O9m0wTHgou = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _ENIZ7d = defineCachedEventHandler(async (ctx) => {
...
const _TEbqpH = lazyEventHandler(() => {
...
const _lazy_x9xCSE = () => Promise.resolve().then(function () { return menu$1; });
const _lazy_WMe9qD = () => Promise.resolve().then(function () { return projects$1; });
const _lazy_WilKMv = () => Promise.resolve().then(function () { return setTimezone$1; });
const _lazy_ZIJra9 = () => Promise.resolve().then(function () { return timezones$1; });
const _lazy_Bcj1M0 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/menu', handler: _lazy_x9xCSE, lazy: true, middleware: false, method: undefined },
  { route: '/api/projects', handler: _lazy_WMe9qD, lazy: true, middleware: false, method: undefined },
  { route: '/api/set-timezone', handler: _lazy_WilKMv, lazy: true, middleware: false, method: undefined },
  { route: '/api/timezones', handler: _lazy_ZIJra9, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Bcj1M0, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ENIZ7d, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _TEbqpH, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Bcj1M0, lazy: true, middleware: false, method: undefined }
];
...
const timezones = defineEventHandler(async (event) => {
  return [
    "Europe/Kaliningrad",
    "Europe/Moscow",
    "Europe/Simferopol",
...
const timezones$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: timezones
});
...
const getClientManifest = () => import('file:///mnt/2E3051B82E95158A/Projects/sirius-dev/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///mnt/2E3051B82E95158A/Projects/sirius-dev/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
