...
declare module 'nitropack' {
  ...
  interface InternalApi {
    ...
    '/api/set-timezone': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/set-timezone').default>>>>
    }
    '/api/timezones': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/timezones').default>>>>
    }
    '/__nuxt_error': {
